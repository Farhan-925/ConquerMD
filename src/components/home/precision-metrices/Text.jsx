  ...
  return (
    <div className="mb-6 md:mb-10 px-4 flex justify-center">
      ...
      <div className="flex flex-col items-center justify-center text-center max-w-3xl">
        <span className="text-[11px] font-[600] uppercase tracking-widest text-[#BBBBBB]">
          Precision Medicine
        </span>
        <h2 className="mt-3 text-center text-[32px] font-[500] sm:text-2xl md:text-3xl text-white leading-relaxed">
